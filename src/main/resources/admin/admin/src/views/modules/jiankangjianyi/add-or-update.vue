	...
	<div class="addEdit-block" :style='{"padding":"30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="健康分析" prop="jiankangfenxi">
					<editor 
						style="min-width: 200px; max-width: 600px;"
						v-model="ruleForm.jiankangfenxi" 
						class="editor" 
						action="file/upload">
					</editor>
				</el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.jiankangfenxi" label="健康分析" prop="jiankangfenxi">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiankangfenxi"></span>
                </el-form-item>
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-if="type!='info'"  label="健康建议" prop="jiankangjianyi">
					<editor 
						style="min-width: 200px; max-width: 600px;"
				...
				<el-form-item :style='{"width":"45%","margin":"0 2% 20px 0","display":"inline-block"}' v-else-if="ruleForm.jiankangjianyi" label="健康建议" prop="jiankangjianyi">
                    <span :style='{"fontSize":"14px","lineHeight":"40px","color":"#333","fontWeight":"500","display":"inline-block"}' v-html="ruleForm.jiankangjianyi"></span>
                </el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='jiankangfenxi'){
							this.ruleForm.jiankangfenxi = obj[o];
							this.ro.jiankangfenxi = true;
							continue;
						}
						if(o=='jiankangjianyi'){
    ...
    info(id) {
      this.$http({
        ...
        this.ruleForm.jiankangfenxi = this.ruleForm.jiankangfenxi.replace(reg,'../../../springboot5416p/upload');
        this.ruleForm.jiankangjianyi = this.ruleForm.jiankangjianyi.replace(reg,'../../../springboot5416p/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
